...
SSLStream.prototype._cycle = function()
{
  ...
  if (bytesRead > 0) {
    console.log('Read ' + bytesRead + ' bytes from clearout');
...
SSLStream.prototype.write = function (data, encoding, fd)
{
  ...
  while (this._pending.length !== 0) {
    ...
    console.log('Writing '+ buf.length +' bytes cleartext');
...
SSLStream.prototype._read = function (data)
{
  ...
  console.log('Read '+ bytesWritten +' bytes encrypted');
  this._cycle();
  return bytesWritten;
};
